...
export const MODULE_CATALOG: ModuleInfo[] = [
  ...
  { id: "purchasing", label: "Purchasing (Procurement)", description: "Vendors, purchase orders, receipts, bills, AP aging", href: "/purchasing" },
  { id: "crm", label: "CRM", description: "Customers and deal pipeline", href: "/crm" },
  { id: "sales", label: "Sales", description: "Quotes that convert to invoices, deal pipeline", href: "/sales" },
