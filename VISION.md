...
The system should understand context, select required modules and services, execute through the shared command layer, and explain every decision.

Where interaction needs structure, the chat surface can render **validated UI components** (forms, buttons, confirmations) — not free-form side effects.
